proc read_params_from_file {fname} {
    ...
    set param(originator_queue_size) [lindex $param_line [incr i]]
    set param(relay_queue_size) [lindex $param_line [incr i]]
    ...
    set param(ramp_time_us) [lindex $param_line [incr i]]
